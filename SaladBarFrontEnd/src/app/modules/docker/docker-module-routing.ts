...
import { DockerContainersListViewComponent } from './docker-modules/docker-containers-list-view/docker-containers-list-view.component';
...
const routes: Routes = [
  ...
  {path: 'containers', component: DockerContainersListViewComponent},
